...
- _initInStatusBar:fp12 withLength:(float)fp36 withPriority:(int)fp20;	// IMP=0x74f21234
...
- (void)setLength:(float)fp36;	// IMP=0x74f20dac
...
- (float)defaultLength;	// IMP=0x74f212a0
